...
btn1 = tkinter.Button(window1, fg = 'blue', text="uickZoom", font = ('Arial', 13, 'bold'), command=callback, highlightbackground='blue', highlightthickness=5).grid(row = 1, column = 1, padx = 10)
